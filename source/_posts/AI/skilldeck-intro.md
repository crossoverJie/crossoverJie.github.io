...
tags:
  ...
  - macOS
  - SwiftUI
banner_img: https://cdn.jsdelivr.net/gh/crossoverJie/images@main/images/1aa3d539_cover.png
index_img: https://cdn.jsdelivr.net/gh/crossoverJie/images@main/images/1aa3d539_cover.png
---
# 背景
...
![Dashboard Overview](https://cdn.jsdelivr.net/gh/crossoverJie/images@main/images/images20260213123118.png)

## Skills 市场浏览

内置了 [skills.sh](https://skills.sh) 的排行榜浏览，支持 All Time、Trending、Hot 三种排序方式，还有搜索功能。看到喜欢的 Skill 可以直接一键安装，不用再手动 clone 了。

![Registry Browser](https://cdn.jsdelivr.net/gh/crossoverJie/images@main/images/images20260224114425.png)
...
![Install & Update](https://cdn.jsdelivr.net/gh/crossoverJie/images@main/images/images20260213122805.png)
...
项目开源，MIT 协议，欢迎 star/issue/PR：[GitHub - crossoverJie/SkillDeck](https://github.com/crossoverJie/SkillDeck)
