...
**这带来的问题**：由于完全依赖模型判断，存在不可靠性。[有测试表明](https://medium.com/data-science-collective/claude-skills-a-technical-deep-dive-into-context-injection-architecture-ee6bf30cf514) skills 经常没有被自动激活，模型会直接跳过它们。这就是为什么：
1. 有些人推荐用 **hooks** 强制注入
...
| 开放标准 | Claude Code 专属 | Agent Skills 标准实现 |
